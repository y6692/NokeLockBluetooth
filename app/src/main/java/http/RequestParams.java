...
//        	try {
//    	    	byte[] resBytes = RSAUtils.encryptByPublicKey(value.getBytes(), MyKey.cliPublicKey);
//				String res = Base64Utils.encode(resBytes);
//				urlParams.put(key, res);
//			} catch (Exception e) {}
//        }
    }
...
//        if (key != null) {
//        	try {
//    	    	byte[] resBytes = RSAUtils.encryptByPublicKey(String.valueOf(value).getBytes(), MyKey.cliPublicKey);
//				String res = Base64Utils.encode(resBytes);
//				urlParams.put(key, res);
//			} catch (Exception e) {}
//        }
