...
//    public static byte[] password = {0x32, 0x30, 0x31, 0x37, 0x31, 0x35};
    ...
    public static final String OPEN_ACTION_SERIAL = "com.sunshine.blelibrary.config.open_action_serial";
    ...
    public static final String RF_TEST = "com.sunshine.blelibrary.config.RF_TEST";

    public static final String RESULT_STATUS = "com.sunshine.blelibrary.config.RESULT_STATUS";

    public static final String DATA_PULL = "com.sunshine.blelibrary.config.DATA_PULL";
    public static final String ALERT_ACTION = "com.sunshine.blelibrary.config.ALERT_ACTION";
    public static final String OPEN_BATTERY_ACTION = "com.sunshine.blelibrary.config.OPEN_BATTERY_ACTION";
    public static final String CLOSE_BATTERY_ACTION = "com.sunshine.blelibrary.config.CLOSE_BATTERY_ACTION";
    public static final String STATUS_BATTERY_ACTION = "com.sunshine.blelibrary.config.STATUS_BATTERY_ACTION";
    public static final String UPDATE_WAKE_ACTION = "com.sunshine.blelibrary.config.UPDATE_WAKE_ACTION";
    public static final String FIND_CAR = "com.sunshine.blelibrary.config.FIND_CAR";
    public static final String REPLACEMENT_BATTERY = "com.sunshine.blelibrary.config.REPLACEMENT_BATTERY";
    public static final String SET_CONNECTION_MODE = "com.sunshine.blelibrary.config.SET_CONNECTION_MODE";

    public static final String RF_ID = "com.sunshine.blelibrary.config.RF_ID";
    public static IntentFilter initFilter() {
        ...
        intentFilter.addAction(UPDATE_WAKE_ACTION);
        ...
        intentFilter.addAction(RESULT_STATUS);
        intentFilter.addAction(DATA_PULL);
        intentFilter.addAction(ALERT_ACTION);
        intentFilter.addAction(RF_ID);
        intentFilter.addAction(STATUS_BATTERY_ACTION);
        intentFilter.addAction(OPEN_BATTERY_ACTION);
        intentFilter.addAction(CLOSE_BATTERY_ACTION);
        intentFilter.addAction(FIND_CAR);
        intentFilter.addAction(OPEN_ACTION_SERIAL);
        intentFilter.addAction(REPLACEMENT_BATTERY);
        intentFilter.addAction(SET_CONNECTION_MODE);
        return intentFilter;
    }
}
