    ...
    public static void printServices(BluetoothGatt gatt) {
        if (gatt != null) {
            for (BluetoothGattService service : gatt.getServices()) {
                Log.i("AndroidBLe","service: " + service.getUuid());
                for (BluetoothGattCharacteristic characteristic : service.getCharacteristics()) {
                    Log.i("AndroidBLe","  characteristic: " + characteristic.getUuid() + " value: " + Arrays.toString(characteristic.getValue()));
                    for (BluetoothGattDescriptor descriptor : characteristic.getDescriptors()) {
                        Log.i("AndroidBLe","        descriptor: " + descriptor.getUuid() + " value: " + Arrays.toString(descriptor.getValue()));
                    }
                }
            }
        }
    ...
    public static boolean refreshDeviceCache(BluetoothGatt gatt) {
        ...
        try {
            ...
            if (refresh != null) {
                ...
                Log.i("AndroidBLe","Refreshing result: " + success);
                return success;
            }
        } catch (Exception e) {
            Log.i("AndroidBLe","An exception occured while refreshing device" + e);
        }
        return false;
    }
