...
//        }
    ...
    public static int compareVersion(String version1, String version2) {
        ...
        Logger.d("HomePageActivity", "version1Array=="+version1Array.length);
        Logger.d("HomePageActivity", "version2Array=="+version2Array.length);
        int index = 0;
        // 获取最小长度值
        int minLen = Math.min(version1Array.length, version2Array.length);
        int diff = 0;
        // 循环判断每位的大小
        Logger.d("HomePageActivity", "verTag2=2222="+version1Array[index]);
        while (index < minLen
